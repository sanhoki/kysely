  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main$body() {
      var $async$goto = 0,
        ...
        kysymys_maara, t2, t3, t1, kysymykset, $async$temp1, $async$temp2;
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      if (t1.indeksi >= A._asNum(t3.get$length(t2))) {
        ...
        t3 = t2.querySelector("#vastaukset");
        if (t3 != null)
          J.get$children$x(t3).clear$0(0);
        t2 = t2.querySelector("#kysymys");
        if (t2 != null)
          J.set$text$x(t2, "P\xe4\xe4sit Loppuun! Oikeita vastauksia: " + $.globaali + "/" + A.S(this.kysymys_maara));
      } else
